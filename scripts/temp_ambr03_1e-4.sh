...
#SBATCH -e /pscratch/sd/n/niranjan/error/clf_error_rep/opta_1296_combis/optatune.%A_multilabels_1e-4_40e_ambr03.err
#SBATCH -o /pscratch/sd/n/niranjan/error/clf_error_rep/opta_1296_combis/optatune.%A_multilabels_1e-4_40e_ambr03.out
#SBATCH -J multilabels_1e-4_40e_ambr03. # Job name

# Assign custom name (SLURM_ARRAY_TASK_ID is replaced with the custom name)
task_name="multilabels_1e-4_40e_ambr03."
