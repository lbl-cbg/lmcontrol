...
#SBATCH -e /pscratch/sd/n/niranjan/error/clf_error_rep/opta_1296_combis/optatune.%A_s1_ambr01_1e-3_40e.err
#SBATCH -o /pscratch/sd/n/niranjan/error/clf_error_rep/opta_1296_combis/optatune.%A_s1_ambr01_1e-3_40e.out
#SBATCH -J s1_ambr01_1e-3_40e  # Job name

# Assign custom name (SLURM_ARRAY_TASK_ID is replaced with the custom name)
task_name="s1_ambr01_1e-3_40e"
